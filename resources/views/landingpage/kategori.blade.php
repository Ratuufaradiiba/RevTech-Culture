            ...
            <div class="col-lg-6">
                ...
                <article class="post-grid mb-5">
                    <div class="post-thumb mb-4">
                        ...
                        <img src="{{ url('admin\media\no-image-found.png') }}" alt="" class="img-fluid w-100" />
                        @else
                        <img src="{{ asset($row->gambar_culture) }}" alt="" class="img-fluid w-100" />
                        @endempty
                    </div>
                    <span class="cat-name text-color font-extra text-sm text-uppercase letter-spacing-1">{{ $row->kategori->nama_kategori }}</span>
